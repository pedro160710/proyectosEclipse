...
public class ServicioLibro {
	 ...
	 * @return
	 */
	public List<Libro> findByTituloLibroLista(String titulo) {
		...
		try {
			...
			libroEncontrado = (List<Libro>) query.getResultList();

			em.getTransaction().commit();
		} catch (Exception e) {
			System.out.println("Error al consultar Libro por nombre lista");
		} finally {
			em.close();
		}
