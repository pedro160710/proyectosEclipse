...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.jboss.samples.webservices.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://localhost:8080/PreubaSOAP/HelloWorld";
    ...
    public org.jboss.samples.webservices.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.jboss.samples.webservices.HelloWorldServiceSoapBindingStub _stub = new org.jboss.samples.webservices.HelloWorldServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.jboss.samples.webservices.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.jboss.samples.webservices.HelloWorldServiceSoapBindingStub _stub = new org.jboss.samples.webservices.HelloWorldServiceSoapBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.samples.jboss.org/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.samples.jboss.org/", "HelloWorldPort"));
        }
